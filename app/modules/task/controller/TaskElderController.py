...
from app.modules.task.dto.TaskDto import TaskCompleteDto, TaskResponseDto, TaskDetailDto
...
def complete_task(
    ...
    """老人完成任务"""
    task = TaskService.complete_task_by_elder(db, task_id, payload.feedback)
    if not task:
